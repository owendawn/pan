...
@section("content")
    ...
    <div class="panel-body scroll">
        ...
        <div class="col-xs-12  nav-menu " style="margin-bottom: 10px;font-size: 14pt;text-align: left;">
            <a href="{{$base_url}}/enjoy/enjoyedit" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="应用管理">
                <i class="glyphicon glyphicon-th-list"></i>
            </a>
        </div>
        <div class="col-xs-12" style="padding:0;margin-bottom:10px; box-shadow: 0 -4px 13px 0px rgba(0,0,0,.3);margin-left: -16px;width: 109%;">
                    ...
                    for(var i=0;i<counts;i++){
                        ...
                        if(i<urls.length) {
                           img=urls[i];
                            ...
                            img='http://thecodeplayer.com/u/uifaces/' + i + '.jpg';
                        }
                        if(i%2==0) {
                        ...
                        imgs.push([
                            ...
                            '       <figure>',
                            '           <img src="'+img+'" alt="" />',
                            '           <figcaption class="img-caption">梦想的声音-<a href="http://www.baidu.com" style="font-size: 16pt;font-weight: bold;color: blue;"><i class="icono-chain" style="width:5px;"></i></a></figcaption>',
                            '       </figure>',
                            '   </a>',
                            '</li>'
                        ].join(""))
