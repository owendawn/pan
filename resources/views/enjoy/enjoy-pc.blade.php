...
@section("content")
    ...
    <div class="panel-body scroll">
        {{--enjoy--}}
        {{--{{var_dump($isMobile==false)}}--}}
        {{--<a href="{{$base_url}}/enjoy/enjoyedit">enjoy edit</a>--}}
        <div class="col-xs-12  nav-menu " style="margin-bottom: 10px;font-size: 14pt;">
            <a href="{{$base_url}}/enjoy/enjoyedit" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="应用管理">
      ...
      {{--      <script src="//cdn.bootcss.com/picturefill/3.0.2/picturefill.min.js"></script>
            <script src="//cdn.bootcss.com/lightgallery/1.2.21/js/lightgallery.js"></script>
            <script src="//cdn.bootcss.com/lightgallery/1.2.21/js/lg-pager.min.js"></script>
            <script src="//cdn.bootcss.com/lightgallery/1.2.21/js/lg-autoplay.min.js"></script>
        ...
        <script src="{{$base_url}}/js/enjoy/inputanimation.js"></script>
            ...
            <script type="text/javascript">
                var images = "<ul id='lightgallery' class='list-unstyled'>", count = 20, complete = 0;
                var imgs=[
                    "http://d.139.sh/owendawn139/temp/a.jpg",
                        "http://t3.baidu.com/it/u=100915938,2415136334&fm=20",
                        "http://t1.baidu.com/it/u=1588936705,3950856896&fm=20"
                ];
                for (var i = 0; i <= count; i++) {
                    var url='http://thecodeplayer.com/u/uifaces/' + i + '.jpg';
                    url=i<imgs.length?imgs[i]:url;
                    images +=''+
                            '<li >'+
                            '   <a>'+
                            ...
                            '               </i>'+
                            '               <i data-link="http://www.baidu.com" onclick="jumpUrl(this);" class="fa fa-link"></i>'+
                            '           </div>'+
                            '       </div>'+
                            '   </a>'+
                            '</li>';
